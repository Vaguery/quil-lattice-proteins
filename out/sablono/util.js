...
var x__25538__auto__ = (((x == null))?null:x);
var m__25539__auto__ = (sablono.util.to_str[goog.typeOf(x__25538__auto__)]);
if(!((m__25539__auto__ == null))){
return m__25539__auto__.call(null,x);
} else {
var m__25539__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__25539__auto____$1 == null))){
return m__25539__auto____$1.call(null,x);
} else {
...
var x__25538__auto__ = (((x == null))?null:x);
var m__25539__auto__ = (sablono.util.to_uri[goog.typeOf(x__25538__auto__)]);
if(!((m__25539__auto__ == null))){
return m__25539__auto__.call(null,x);
} else {
var m__25539__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__25539__auto____$1 == null))){
return m__25539__auto____$1.call(null,x);
} else {
...
var len__25983__auto___27016 = arguments.length;
var i__25984__auto___27017 = (0);
while(true){
if((i__25984__auto___27017 < len__25983__auto___27016)){
args__25990__auto__.push((arguments[i__25984__auto___27017]));

var G__27018 = (i__25984__auto___27017 + (1));
i__25984__auto___27017 = G__27018;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__25991__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq27015){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27015));
});
...
var vec__27022 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__27024;
var words = seq__27023__$1;
...
var G__27026 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__27026,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono.util.camel_case_keys);
} else {
return G__27026;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__27027_SHARP_){
if(typeof p1__27027_SHARP_ === 'string'){
return p1__27027_SHARP_;
} else {
return cljs.core.seq.call(null,p1__27027_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__24875__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1479816749552