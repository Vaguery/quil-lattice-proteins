...
var args29329 = [];
var len__25983__auto___29333 = arguments.length;
var i__25984__auto___29334 = (0);
while(true){
if((i__25984__auto___29334 < len__25983__auto___29333)){
args29329.push((arguments[i__25984__auto___29334]));

var G__29335 = (i__25984__auto___29334 + (1));
i__25984__auto___29334 = G__29335;
continue;
} else {
}
break;
...
var G__29332 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__29332,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__29332;
}
});
...
var or__24875__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__25983__auto___29340 = arguments.length;
var i__25984__auto___29341 = (0);
while(true){
if((i__25984__auto___29341 < len__25983__auto___29340)){
args__25990__auto__.push((arguments[i__25984__auto___29341]));

var G__29342 = (i__25984__auto___29341 + (1));
i__25984__auto___29341 = G__29342;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__25991__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq29337){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__29338,G__29339,seq29337__$2);
});
...
var file = cljs.core.get.call(null,map__29346__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__29346__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__29346__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__29346,map__29346__$1,file,line,column){
return (function (p1__29343_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__29343_SHARP_));
});})(map__29346,map__29346__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__25803__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__25803__auto__,prefer_table__25804__auto__,method_cache__25805__auto__,cached_hierarchy__25806__auto__,hierarchy__25807__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__24875__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__24875__auto__)){
return or__24875__auto__;
} else {
...
var temp__4657__auto___29348 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___29348)){
var message_29349 = temp__4657__auto___29348;
cljs.core.println.call(null,message_29349);
} else {
}
...
var temp__4657__auto___29350 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___29350)){
var message_29351 = temp__4657__auto___29350;
cljs.core.println.call(null,message_29351);
} else {
}
...
var temp__4655__auto__ = (function (){var and__24863__auto__ = typeof exception.stack === 'string';
if(and__24863__auto__){
var G__29361 = exception.stack;
var G__29361__$1 = (((G__29361 == null))?null:clojure.string.split_lines.call(null,G__29361));
var G__29361__$2 = (((G__29361__$1 == null))?null:cljs.core.get.call(null,G__29361__$1,depth));
if((G__29361__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__29361__$2);
}
} else {
...
var vec__29362 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__29362,(0),null);
var column = cljs.core.nth.call(null,vec__29362,(1),null);
var vec__29365 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__29365,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__29365,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__29365,(2),null);
...
var m__$1 = (function (){var G__29369 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__29369) {
case "fail":
...
var G__29375 = (function (){var G__29374 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__29374);
} else {
return G__29374;
}
})();
...
return cljs.core.vary_meta.call(null,G__29377,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__29381 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__29381) {
...
var vec__29386 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__29386,(0),null);
var types = vec__29386;
...
return cljs.core.map.call(null,(function (p__29398){
var vec__29399 = p__29398;
var ns = cljs.core.nth.call(null,vec__29399,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__29399,(1),null);
return ((function (vec__29399,ns,vars__$1){
return (function (){
...
var G__29402 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__29402) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__29402,env,once_fixtures,each_fixtures,vec__29399,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__29402,env,once_fixtures,each_fixtures,vec__29399,ns,vars__$1){
return (function (){
var seq__29403 = cljs.core.seq.call(null,vars__$1);
var chunk__29404 = null;
var count__29405 = (0);
var i__29406 = (0);
while(true){
if((i__29406 < count__29405)){
var v = cljs.core._nth.call(null,chunk__29404,i__29406);
var temp__4657__auto___29408 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___29408)){
var t_29409 = temp__4657__auto___29408;
each_fixture_fn.call(null,((function (seq__29403,chunk__29404,count__29405,i__29406,t_29409,temp__4657__auto___29408,v,each_fixture_fn,G__29402,env,once_fixtures,each_fixtures,vec__29399,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_29409)));
});})(seq__29403,chunk__29404,count__29405,i__29406,t_29409,temp__4657__auto___29408,v,each_fixture_fn,G__29402,env,once_fixtures,each_fixtures,vec__29399,ns,vars__$1))
);
} else {
}
...
var c__25689__auto__ = cljs.core.chunk_first.call(null,seq__29403__$1);
var G__29414 = cljs.core.chunk_rest.call(null,seq__29403__$1);
var G__29415 = c__25689__auto__;
var G__29416 = cljs.core.count.call(null,c__25689__auto__);
var G__29417 = (0);
seq__29403 = G__29414;
...
var v = cljs.core.first.call(null,seq__29403__$1);
var temp__4657__auto___29418__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___29418__$1)){
var t_29419 = temp__4657__auto___29418__$1;
each_fixture_fn.call(null,((function (seq__29403,chunk__29404,count__29405,i__29406,t_29419,temp__4657__auto___29418__$1,v,seq__29403__$1,temp__4657__auto__,each_fixture_fn,G__29402,env,once_fixtures,each_fixtures,vec__29399,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_29419)));
});})(seq__29403,chunk__29404,count__29405,i__29406,t_29419,temp__4657__auto___29418__$1,v,seq__29403__$1,temp__4657__auto__,each_fixture_fn,G__29402,env,once_fixtures,each_fixtures,vec__29399,ns,vars__$1))
);
} else {
}

var G__29420 = cljs.core.next.call(null,seq__29403__$1);
var G__29421 = null;
var G__29422 = (0);
var G__29423 = (0);
seq__29403 = G__29420;
chunk__29404 = G__29421;
count__29405 = G__29422;
i__29406 = G__29423;
continue;
}
} else {
...
});})(each_fixture_fn,G__29402,env,once_fixtures,each_fixtures,vec__29399,ns,vars__$1))
);
});})(each_fixture_fn,G__29402,env,once_fixtures,each_fixtures,vec__29399,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1479816753291