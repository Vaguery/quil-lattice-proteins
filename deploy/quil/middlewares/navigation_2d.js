...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([initial_state,p1__13953_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var nav_2d_13954 = cljs.core.cst$kw$navigation_DASH_2d.cljs$core$IFn$_invoke$arity$1(state);
var zoom_13955 = cljs.core.cst$kw$zoom.cljs$core$IFn$_invoke$arity$1(nav_2d_13954);
var pos_13956 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(nav_2d_13954);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_13955);

var tr__8120__auto___13957 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_13955) - cljs.core.first(pos_13956)),(((quil.core.height() / (2)) / zoom_13955) - cljs.core.second(pos_13956))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__8120__auto___13957);
...
var G__13962 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__13963 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__13962,G__13963) : user_mouse_dragged.call(null,G__13962,G__13963));
...
return (function (state,event){
var G__13964 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__13965 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__13964,G__13965) : user_mouse_wheel.call(null,G__13964,G__13965));
});})(user_settings,user_draw,user_mouse_dragged,user_mouse_wheel,setup))
], 0));
});
